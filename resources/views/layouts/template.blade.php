    ...
    <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-l">
        <div class="p-6">
            ...
            <i class="fas fa-graduation-cap"></i>
                SISTEM PERPUSTAKAAN
                <hr size="15px">
             <a class="text-white text-1l" ><b>SISTEM PERPUSTAKAAN</b></a>
        ...
        <nav class="text-white text-base font-semibold pt-3">
            <a href="buku" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
                <i class="fas fa-laptop-house mr-3"></i>
                Buku
            </a>
            <a href="/member" class="flex items-center text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item">
                <i class="fas fa-user-graduate mr-3"></i>
                Anggota
            </a>
            <a href="/transaksi" class="flex items-center text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item">
